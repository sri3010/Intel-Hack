...
export default function AudiocallGameOnePage() {
  return (
    <>
      <Helmet>
      ...
      <div className="w-full">
        ...
        <div>
          <div className="flex justify-center px-14 py-[100px] md:p-5 bg-gray-100">
            <div className="flex md:flex-col justify-center items-center w-[41%] md:w-full gap-2.5 p-4 bg-white-A700 shadow-sm rounded-[14px]">
                  ...
                  <div>
                    <div className="flex justify-between items-start gap-5">
                      <Img
                        ...
                        alt="imagefiftytwo"
                        className="w-[23%] mt-[30px] object-cover"
                      />
                      <div className="flex flex-col w-[39%] gap-[21px]">
                        <Img src="images/img_image_53.png" alt="imagefiftythree" className="object-cover" />
                        <Img
                          src="images/img_image_51.png"
                          alt="imagefiftyone"
                          className="w-[59px] ml-[26px] md:ml-0 object-cover"
                        />
                      </div>
                    </div>
                    <Img
                      ...
                      alt="imagetwentynine"
                      className="h-[408px] w-full md:h-auto mt-[-131px] object-cover"
                    />
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-start gap-[29px] flex-1">
                ...
                <div className="flex flex-col self-stretch gap-[9px]">
                  ...
                  <div className="flex justify-between pr-[13px] gap-5">
                    ...
                    <a
                      href="#"
                      className="flex justify-center items-center h-[44px] w-[44px] border-red-400 border-[3px] border-solid bg-red-400_4c rounded-[50%]"
                    >
                      <Heading as="h5" className="!text-red-400 tracking-[-0.64px] text-center">
                        B1
                      </Heading>
                    </a>
                    <a
